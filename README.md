...
| Provider | How to Get Key | Payment |
|----------|---------------|---------|
| **Google Gemini** ⭐ | [aistudio.google.com/apikey](https://aistudio.google.com/apikey) | Free with Google account |
| **OpenAI (GPT)** | [platform.openai.com](https://platform.openai.com/api-keys) | Visa/Mastercard/支付宝 |
| **Claude (Anthropic)** | [console.anthropic.com](https://console.anthropic.com/) | Visa/Mastercard (US) |
